            ...
            <div class="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden transition-all duration-300">
                <div class="p-6 md:p-12">
                    <form action="{{ route('layanan.karir.store') }}" method="POST" class="space-y-10">
                        ...
                        {{-- SEKSI 03: RENCANA BMW --}}
                        <div class="space-y-6">
                            <div class="flex items-center gap-4 mb-8">
                                <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center font-black shadow-sm">03</div>
                                <h3 class="text-xl font-black text-gray-900 tracking-tight">Rencana Masa Depan (BMW)</h3>
                            </div>

                            <div class="space-y-4">
                                <label class="block text-sm font-bold text-gray-700 ml-1">Apa rencanamu setelah lulus nanti?</label>
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <label class="relative cursor-pointer group">
                                        <input type="radio" name="career_path" value="Bekerja" class="peer sr-only" required>
                                        <div class="p-4 bg-gray-50 rounded-2xl border-2 border-transparent peer-checked:border-emerald-500 peer-checked:bg-emerald-50 transition-all group-hover:bg-gray-100 text-center">
                                            <div class="text-[10px] font-black uppercase tracking-widest text-emerald-600 mb-1">Bekerja</div>
                                            <div class="font-bold text-gray-600 peer-checked:text-emerald-900">Langsung Karir</div>
                                        </div>
                                    </label>
                                    <label class="relative cursor-pointer group">
                                        <input type="radio" name="career_path" value="Melanjutkan" class="peer sr-only">
                                        <div class="p-4 bg-gray-50 rounded-2xl border-2 border-transparent peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all group-hover:bg-gray-100 text-center">
                                            <div class="text-[10px] font-black uppercase tracking-widest text-blue-600 mb-1">Melanjutkan</div>
                                            <div class="font-bold text-gray-600 peer-checked:text-blue-900">Kuliah / Studi</div>
                                        </div>
                                    </label>
                                    <label class="relative cursor-pointer group">
                                        <input type="radio" name="career_path" value="Wirausaha" class="peer sr-only">
                                        <div class="p-4 bg-gray-50 rounded-2xl border-2 border-transparent peer-checked:border-amber-500 peer-checked:bg-amber-50 transition-all group-hover:bg-gray-100 text-center">
                                            <div class="text-[10px] font-black uppercase tracking-widest text-amber-600 mb-1">Wirausaha</div>
                                            <div class="font-bold text-gray-600 peer-checked:text-amber-900">Membangun Bisnis</div>
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="pt-4 space-y-2">
                                <label class="block text-sm font-bold text-gray-700 ml-1">
                                    Detail Cita-cita & Keluhan <span class="text-xs text-gray-400 font-normal">(Opsional)</span>
                                </label>
                                <textarea name="cita_cita_keluhan" rows="4" 
                                    placeholder="Ceritakan impianmu atau hal yang membuatmu ragu di sini (boleh dikosongkan)..." 
