<x-app-layout>
    <x-slot name="header">
        {{-- Margin top disesuaikan agar tidak terlalu mepet navbar --}}
        <div class="mt-16 md:mt-24 flex flex-col md:flex-row md:items-center md:justify-between gap-6 py-4">
        </div>
    </x-slot>

    {{-- pt-28 md:pt-24 penting untuk margin top dekstop dan responsive --}}
    <div class="pt-28 md:pt-24 pb-24 px-4 sm:px-6 lg:px-8" x-data="{ showChatMenu: false }">
        ...
        {{-- z-[9999] memastikan tombol ini di atas segalanya --}}
        <div class="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[9999] flex flex-col items-end gap-3">
            ...
            <div x-show="showChatMenu" 
                ...
                <a href="https://wa.me/6281234567890" target="_blank" 
                   class="bg-white hover:bg-emerald-50 text-gray-900 px-6 py-4 rounded-2xl shadow-2xl border border-emerald-100 flex items-center gap-3 transition-all active:scale-95 group">
