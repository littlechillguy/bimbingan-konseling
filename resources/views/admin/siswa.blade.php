                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors"
                                ...
                                <td class="px-8 py-5 text-center">
                                    <button @click="s = {
                                        ...
                                        tanggal_lahir: '{{ \Carbon\Carbon::parse($siswa->tanggal_lahir)->format('d M Y') }}',
                                        smp: '{{ $siswa->asal_smp ?? '-' }}',
            ...
            <div class="bg-white rounded-[2.5rem] shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col" @click.away="openModal = false">
                <div class="p-8 overflow-y-auto custom-scrollbar">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        {{-- Data Akademik --}}
                        <div class="space-y-4">
                            <h4 class="text-[10px] font-black text-teal-600 uppercase tracking-[0.2em] border-b border-teal-100 pb-2">Informasi Akademik</h4>
                            ...
                            <div><p class="text-[10px] text-slate-400 uppercase font-bold">Asal Sekolah</p><p class="text-sm font-bold text-slate-700" x-text="s.smp"></p></div>
                        </div>
